export const IconDelete = ({...props}) => {
    return (
        <svg width="18" height="20" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M18 5C18 4.44772 17.5523 4 17 4C16.4477 4 16 4.44772 16 5H18ZM4 5C4 4.44772 3.55228 4 3 4C2.44772 4 2 4.44772 2 5H4ZM5 5C5 5.55228 5.44772 6 6 6C6.55228 6 7 5.55228 7 5H5ZM13 5C13 5.55228 13.4477 6 14 6C14.5523 6 15 5.55228 15 5H13ZM17 5H16V19H17H18V5H17ZM17 19H16C16 19.5523 15.5523 20 15 20V21V22C16.6569 22 18 20.6569 18 19H17ZM15 21V20H5V21V22H15V21ZM5 21V20C4.44772 20 4 19.5523 4 19H3H2C2 20.6569 3.34315 22 5 22V21ZM3 19H4V5H3H2V19H3ZM6 5H7V3H6H5V5H6ZM6 3H7C7 2.44772 7.44772 2 8 2V1V0C6.34315 0 5 1.34315 5 3H6ZM8 1V2H12V1V0H8V1ZM12 1V2C12.5523 2 13 2.44772 13 3H14H15C15 1.34315 13.6569 0 12 0V1ZM14 3H13V5H14H15V3H14Z" fill="white"/>
